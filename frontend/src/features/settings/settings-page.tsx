        ...
        <Tabs defaultValue="build" className="flex min-w-0 flex-col gap-7 lg:flex-row lg:items-start">
          ...
          <SettingsSection title={t("settings.routing.title")}>
            <div className="space-y-0">
              ...
              <SettingsField controlId="routing-build-high-token-speed-auto-disable" label={t("settings.routing.buildHighTokenSpeedAutoDisable")} description={t("settings.routing.buildHighTokenSpeedAutoDisableHelp")}><Controller control={form.control} name="routing.buildHighTokenSpeedAutoDisable" render={({ field }) => <div className="flex h-9 items-center"><Switch id="routing-build-high-token-speed-auto-disable" checked={field.value} onCheckedChange={field.onChange} /></div>} /></SettingsField>
              <SettingsField controlId="routing-build-high-token-speed-threshold" label={t("settings.routing.buildHighTokenSpeedThreshold")} description={t("settings.routing.buildHighTokenSpeedThresholdHelp")} error={form.formState.errors.routing?.buildHighTokenSpeedThreshold?.message}><Input id="routing-build-high-token-speed-threshold" type="number" min={1} max={100_000} step="1" disabled={!form.watch("routing.buildHighTokenSpeedAutoDisable")} {...form.register("routing.buildHighTokenSpeedThreshold", { valueAsNumber: true })} /></SettingsField>
              <SettingsField controlId="routing-build-high-token-speed-model-ids" label={t("settings.routing.buildHighTokenSpeedModelIDs")} description={t("settings.routing.buildHighTokenSpeedModelIDsHelp")} error={form.formState.errors.routing?.buildHighTokenSpeedModelIDs?.message}><Textarea id="routing-build-high-token-speed-model-ids" rows={4} disabled={!form.watch("routing.buildHighTokenSpeedAutoDisable")} placeholder={t("settings.routing.buildHighTokenSpeedModelIDsPlaceholder")} {...form.register("routing.buildHighTokenSpeedModelIDs")} /></SettingsField>
