    ...
    translation: {
      ...
      settings: {
        ...
        accounts: {
          ...
          buildHighTokenSpeedAutoDisableHelp: "默认关闭。开启后，当 Grok Build 指定模型的输出 Token 速度超过阈值时，自动禁用该账号。过高速度通常意味着上游把请求分流到了低级模型。",
          buildHighTokenSpeedThreshold: "Token 速度阈值",
          buildHighTokenSpeedThresholdHelp: "单位：Token/s。开启功能时默认 1000。仅统计成功的流式请求，计算方式与请求审计一致。",
