  ...
  "zh-CN": {
    translation: {
      ...
      statusReauthRequired: "失效",
        ...
        botRiskTooltipSource1: "机器人风控（bot_flag_source/botflagsource/bfs=1）",
        botRiskTooltipSource2: "机器人风控（bot_flag_source/botflagsource/bfs=2）",
      ...
      settings: {
        ...
        accounts: {
          ...
          excludeBuildBotFlaggedFromSchedulingHelp: "开启后，JWT bot_flag_source/botflagsource/bfs 为 1 或 2 的 Grok Build 账号不再参与 Build 渠道调度。账号仍保留在池中，可手动查看与操作。",
          excludeWebBotFlaggedFromScheduling: "风控 Web 号移出调度",
          excludeWebBotFlaggedFromSchedulingHelp: "开启后，SSO JWT 带 bot_flag_source/botflagsource/bfs 为 1 或 2 的 Grok Web 账号不再参与 Web 渠道调度。账号仍保留在池中，可手动查看与操作。",
          excludeConsoleBotFlaggedFromScheduling: "风控 Console 号移出调度",
          excludeConsoleBotFlaggedFromSchedulingHelp: "开启后，标记为风控的 Grok Console 账号不再参与 Console 渠道调度。账号仍保留在池中，可手动查看与操作。",
          cleanupTitle: "账号清理",
