  ...
  "zh-CN": {
    translation: {
      ...
      statusReauthRequired: "失效",
        ...
        botRiskTooltipSource1: "机器人风控（bot_flag_source/bfs=1）。可能影响视频生成能力与其他权限",
        botRiskTooltipSource2: "机器人风控（bot_flag_source/bfs=2）。可能影响视频生成能力与其他权限",
