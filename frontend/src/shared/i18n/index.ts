    ...
    translation: {
      ...
      settings: {
        ...
        accounts: {
          ...
          excludeBuildBotFlaggedFromSchedulingHelp: "开启后，JWT bot_flag_source/botflagsource/bfs 为 1 或 2 的 Grok Build 账号不再参与 Build 渠道调度；关联的 Web / Console 账号调度不受影响。账号仍保留在池中，可手动查看与操作。",
          cleanupTitle: "账号清理",
