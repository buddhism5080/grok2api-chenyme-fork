...
func New(ctx context.Context, cfg config.Config, logger *slog.Logger) (*Application, error) {
	...
	selector.UpdateBuildUsagePenaltyTokenThreshold(cfg.Routing.BuildUsagePenaltyTokenThreshold)
	...
	gatewayService.UpdateBuildHighTokenSpeedAutoDisable(cfg.Routing.BuildHighTokenSpeedAutoDisable, cfg.Routing.BuildHighTokenSpeedThreshold, cfg.Routing.BuildHighTokenSpeedOverheadMS, cfg.Routing.BuildHighTokenSpeedModelIDs)
	gatewayService.UpdateBuildMissingReasoningPenalty(cfg.Routing.BuildMissingReasoningPenaltyEnabled, cfg.Routing.BuildMissingReasoningPenaltyModelIDs, cfg.Routing.BuildMissingReasoningPenaltyUserTurnModelIDs)
	...
	gatewayService.UpdateBuildStreamFirstCharTimeout(effectiveBuildStreamFirstCharTimeout(cfg.Provider.Build))
	...
	settingsService := settingsapp.NewService(cfg, settingsUpdatedAt, settingsRevision, runtimeSettingsRepo, notifySettings, func(next config.Config) {
		...
		gatewayService.UpdateBuildStreamFirstCharTimeout(effectiveBuildStreamFirstCharTimeout(next.Provider.Build))
		...
		selector.UpdateBuildUsagePenaltyTokenThreshold(next.Routing.BuildUsagePenaltyTokenThreshold)
		...
		gatewayService.UpdateBuildHighTokenSpeedAutoDisable(next.Routing.BuildHighTokenSpeedAutoDisable, next.Routing.BuildHighTokenSpeedThreshold, next.Routing.BuildHighTokenSpeedOverheadMS, next.Routing.BuildHighTokenSpeedModelIDs)
		gatewayService.UpdateBuildMissingReasoningPenalty(next.Routing.BuildMissingReasoningPenaltyEnabled, next.Routing.BuildMissingReasoningPenaltyModelIDs, next.Routing.BuildMissingReasoningPenaltyUserTurnModelIDs)
