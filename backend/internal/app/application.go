...
func New(ctx context.Context, cfg config.Config, logger *slog.Logger) (*Application, error) {
	...
	selector.UpdateExcludeBotFlaggedFromScheduling(cfg.Accounts.ExcludeBuildBotFlaggedFromScheduling, cfg.Accounts.ExcludeWebBotFlaggedFromScheduling, cfg.Accounts.ExcludeConsoleBotFlaggedFromScheduling)
	accountService.UpdateExcludeBotFlaggedFromScheduling(cfg.Accounts.ExcludeBuildBotFlaggedFromScheduling, cfg.Accounts.ExcludeWebBotFlaggedFromScheduling, cfg.Accounts.ExcludeConsoleBotFlaggedFromScheduling)
	...
	settingsService := settingsapp.NewService(cfg, settingsUpdatedAt, settingsRevision, runtimeSettingsRepo, notifySettings, func(next config.Config) {
		...
		selector.UpdateExcludeBotFlaggedFromScheduling(next.Accounts.ExcludeBuildBotFlaggedFromScheduling, next.Accounts.ExcludeWebBotFlaggedFromScheduling, next.Accounts.ExcludeConsoleBotFlaggedFromScheduling)
		accountService.UpdateExcludeBotFlaggedFromScheduling(next.Accounts.ExcludeBuildBotFlaggedFromScheduling, next.Accounts.ExcludeWebBotFlaggedFromScheduling, next.Accounts.ExcludeConsoleBotFlaggedFromScheduling)
