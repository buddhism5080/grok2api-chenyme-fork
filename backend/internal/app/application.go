...
func New(ctx context.Context, cfg config.Config, logger *slog.Logger) (*Application, error) {
	...
	gatewayService.UpdateBuildHighTokenSpeedAutoDisable(cfg.Routing.BuildHighTokenSpeedAutoDisable, cfg.Routing.BuildHighTokenSpeedThreshold, cfg.Routing.BuildHighTokenSpeedModelIDs)
	...
	settingsService := settingsapp.NewService(cfg, settingsUpdatedAt, settingsRevision, runtimeSettingsRepo, notifySettings, func(next config.Config) {
		...
		gatewayService.UpdateBuildHighTokenSpeedAutoDisable(next.Routing.BuildHighTokenSpeedAutoDisable, next.Routing.BuildHighTokenSpeedThreshold, next.Routing.BuildHighTokenSpeedModelIDs)
