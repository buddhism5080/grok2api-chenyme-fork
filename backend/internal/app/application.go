...
func New(ctx context.Context, cfg config.Config, logger *slog.Logger) (*Application, error) {
	...
	gatewayService.UpdateBuildMissingReasoningPenalty(cfg.Routing.BuildMissingReasoningPenaltyEnabled, cfg.Routing.BuildMissingReasoningPenaltyModelIDs)
	...
	settingsService := settingsapp.NewService(cfg, settingsUpdatedAt, settingsRevision, runtimeSettingsRepo, notifySettings, func(next config.Config) {
		...
		gatewayService.UpdateBuildMissingReasoningPenalty(next.Routing.BuildMissingReasoningPenaltyEnabled, next.Routing.BuildMissingReasoningPenaltyModelIDs)
