...
func TestNormalizeBuildReasoningEffort(t *testing.T) {
	tests := []struct {
		...
		{name: "4.7 uppercase xhigh", model: "grok-4.7", effort: "XHIGH", want: "xhigh"},
		{name: "4.7 max maps to xhigh", model: "grok-4.7", effort: "max", want: "xhigh"},
		{name: "prefixed 4.7 uppercase max maps to xhigh", model: "Build/grok-4.7", effort: "MAX", want: "xhigh"},
