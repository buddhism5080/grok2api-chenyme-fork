...
var schemaIndexes = []string{
	...
	"CREATE INDEX IF NOT EXISTS idx_account_build_usage_penalties_until ON account_build_usage_penalties(penalty_until, account_id)",
	...
	"CREATE INDEX IF NOT EXISTS idx_audits_missing_reasoning_created_id ON request_audits(created_at DESC, id DESC) WHERE missing_reasoning_penalty",
