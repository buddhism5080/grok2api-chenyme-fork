...
func toAuditDomain(value requestAuditModel) audit.Record {
	...
	return audit.Record{
		...
		ErrorCode: value.ErrorCode, MissingReasoningPenalty: value.MissingReasoningPenalty, RequestMethod: value.RequestMethod, RequestPath: value.RequestPath, RequestHeaders: requestHeaders, AttemptCount: value.AttemptCount, CreatedAt: value.CreatedAt,
	}
}
